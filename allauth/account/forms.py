...
class SignupForm(BaseSignupForm):
    ...
    def _send_account_already_exists_mail(self, request):
        ...
        password_reset_url = "http://localhost:3000" + build_absolute_uri(
...
class ResetPasswordForm(forms.Form):
    ...
    def _send_unknown_account_mail(self, request, email):
        signup_url = "http://localhost:3000" + build_absolute_uri(request,  reverse("account_signup"))
        context = {
            "current_site": get_current_site(request),
            "email": email,
            "request": request,
    ...
    def _send_password_reset_mail(self, request, email, users, **kwargs):
        ...
        for user in users:
            ...
            path = "http://localhost:3000"+ reverse(
